...
class DJSessionAgent:
    ...
    def _session_sys_prompt(self) -> str:
        ...
        return (
            ...
            "If dataset_path is missing or a remote data source is needed, use list_dataset_load_strategies to discover dataset.configs options before build_dataset_spec.\n"
