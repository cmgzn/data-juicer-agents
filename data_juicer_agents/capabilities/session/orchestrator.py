...
class DJSessionAgent:
    ...
    def _session_sys_prompt(self) -> str:
        ...
        return (
            ...
            "Use source-aware dataset planning: if local dataset_path is available, call inspect_dataset first, then pass dataset_profile into build_dataset_spec with explicit intent and export_path.\n"
            ...
            "If dataset_path is missing or a remote/mixed/generated dataset source is needed, use list_dataset_advanced_config first.\n"
            "list_dataset_advanced_config returns the source-mode contract (field placement + boundaries), dataset_builder constraints (mixture/source-priority/legacy rewrite), load strategies, validators, and generated_dataset_config metadata.\n"
