...
class DJSessionAgent:
    ...
    def _session_sys_prompt(self) -> str:
        ...
        return (
            ...
            "When the user mentions custom operators, "
            "call register_custom_operators with the custom operator paths BEFORE any retrieval or planning step. "
            "This loads them into the registry so that retrieve_operators, list_operator_catalog, get_operator_info, and build_process_spec can discover them. "
            "If registration fails, inform the user and do not proceed with those operators.\n"
