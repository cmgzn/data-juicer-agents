...
- Files:
  ...
  - `context/list_dataset_advanced_config/{input.py,logic.py,tool.py}`
- Main responsibilities:
  - dataset inspection
  - dataset schema probing
  - unified dataset advanced-config discovery (spec contract + builder rules + strategies + validators + generators)
